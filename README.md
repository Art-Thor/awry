...
- **Shell integration** — select a profile and get an export command ready to eval
...
# Print export command for a profile
awry export --profile my-profile
```
